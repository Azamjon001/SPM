...
import { getProducts, getSalesHistory, getCustomerOrders, getCompanyExpenses, getFinancialStats } from '../utils/api';
  ...
  const loadData = async () => {
    try {
      ...
      const [
        ...
        fetch(
          `https://${projectId}.supabase.co/functions/v1/make-server-6a74b22c/company-payments?company_id=${companyId}`,
          {
            headers: {
