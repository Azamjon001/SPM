import { Banknote, CheckCircle, CreditCard, Loader, Receipt, Save, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className={`w-full p-6 rounded-2xl border-2 transition-all text-left ${config.mode === 'manual_check'
            ? 'border-blue-600 bg-blue-50 shadow-lg'
            : 'border-gray-200 bg-white hover:border-gray-300'
            }`}
        >
          <div className="flex items-start gap-4">
            <div className={`p-3 rounded-xl ${config.mode === 'manual_check'
        ...
        <button
          ...
          className={`w-full p-6 rounded-2xl border-2 transition-all text-left ${config.mode === 'demo_online'
            ? 'border-purple-600 bg-purple-50 shadow-lg'
            : 'border-gray-200 bg-white hover:border-gray-300'
            }`}
        >
          <div className="flex items-start gap-4">
            <div className={`p-3 rounded-xl ${config.mode === 'demo_online'
        ...
        <button
          ...
          className={`w-full p-6 rounded-2xl border-2 transition-all text-left ${config.mode === 'real_online'
            ? 'border-green-600 bg-green-50 shadow-lg'
            : 'border-gray-200 bg-white hover:border-gray-300'
            }`}
        >
          <div className="flex items-start gap-4">
            <div className={`p-3 rounded-xl ${config.mode === 'real_online'
      ...
      <button
        onClick={saveConfig}
        disabled={saving}
        className={`w-full py-4 rounded-xl font-medium text-white transition-all flex items-center justify-center gap-2 ${saving
