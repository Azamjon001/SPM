import { AlertTriangle, History, Package, Search, TrendingDown } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg transition-colors ${filterType === 'low_stock'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg transition-colors ${filterType === 'out_of_stock'
              ...
              {filteredProducts.map(product => {
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className={`text-lg font-semibold ${isOutOfStock ? 'text-red-600' : isLowStock ? 'text-orange-600' : 'text-green-600'
                        }`}>
                        {product.quantity} шт
                      </div>
                    </td>
